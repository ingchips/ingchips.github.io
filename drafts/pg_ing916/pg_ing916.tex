...
\NormalTok{\{}
    ...
    \DataTypeTok{uint32_t}\NormalTok{ qdecClk = SYSCTRL_GetClk(SYSCTRL_ITEM_APB_QDEC);}
    \DataTypeTok{uint8_t}\NormalTok{ div = hclk / qdecClk;}
    \ControlFlowTok{if}\NormalTok{ (hclk % qdecClk)}
\NormalTok{        div++;}
